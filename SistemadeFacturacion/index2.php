    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" style="background-color: #1B9CBB;">
            ...
            <div class="sidebar-header" style="background-color: #1B9CBB;">
                ...
                <label id="nombre">Grover</label> <br>
                <label id="apellidoPat">Mamani</label>
                <label id="apellidoMat">veizan</label><br>
        ...
        <div id="content" style="margin-top: 80px; padding-left: 20%;">
            <h1 style="margin-top: 20px;margin-bottom: 40px; font-family: Century Gothic"> ADMINISTRACION TOTAL</h1>
        <nav>
                        ...
                        <div class="card mb-10" id="infoCant">
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-7" style="padding-top: 40px;">
                              <div class="card-body">
                                <h5 class="card-title" id="infoLabel"><label>Administrar Categorias</label></h5>
                                <h5 class="card-title" id="infoLabel"><label></label></h5>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <td class="listCate1">
                        ...
                        <div class="card mb-10" id="infoCant">
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-7" style="padding-top: 40px;">
                              <div class="card-body">
                                <h5 class="card-title" id="infoLabel"><label>Administrar Productos</label></h5>
                                <h5 class="card-title" id="infoLabel"><label></label></h5>
                              </div>
                            </div>
                          </div>
                    ...
                    <td class="listCate1">
                        <a href="AdminCliente.php">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-7" style="padding-top: 40px;">
                                        <div class="card-body">
                                            <h5 class="card-title" id="infoLabel"><label>Administrar Clientes</label></h5>
                                            <h5 class="card-title" id="infoLabel"><label></label></h5>
                                        </div>
                                        </div>
                                    </div>
                    ...
                    <a href="AdminCliente.php">
                        <div class="card mb-10" id="infoCant">
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-7" style="padding-top: 40px;">
                              <div class="card-body">
                                <h5 class="card-title" id="infoLabel"><label>Administrar Ventas</label></h5>
                                <h5 class="card-title" id="infoLabel"><label></label></h5>
                              </div>
                            </div>
                          </div>
                        ...
                        <a href="AdminUsuario.php">
                                    <div class="card mb-10" id="infoCant">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-7" style="padding-top: 40px;">
                                            <div class="card-body">
                                                <h5 class="card-title" id="infoLabel"><label>Administrar Usuarios</label></h5>
                                                <h5 class="card-title" id="infoLabel"><label></label></h5>
                                            </div>
                                            </div>
                                        </div>
