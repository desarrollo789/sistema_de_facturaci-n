    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<div class="mdl-tabs__tab-bar">
				<a href="#tabNewClient" class="mdl-tabs__tab is-active">Registrar Cliente</a>
				<a href="#tabListClient" class="mdl-tabs__tab">Lista De Clientes</a>
			</div>
			<div class="mdl-tabs__panel is-active" id="tabNewClient">
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop mdl-cell--2-offset-desktop" style="padding-left: 18%;">
						<div class="full-width panel mdl-shadow--2dp">
							<div class="full-width panel-tittle bg-primary text-center tittles">
								Nuevo Cliente
							</div>
							<div class="full-width panel-content">
								<form method="post" action="ConexionBD/agregarCliente.php">
									<h5 class="text-condensedLight">Datos del Cliente </h5>
									
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="NitClient" name="NitClient">
										<label class="mdl-textfield__label" for="DNIClient">NIT</label>
										<span class="mdl-textfield__error">invalido solo numeros</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NombreClient" name="NombreClient">
										<label class="mdl-textfield__label" for="NameClient">NOMBRE</label>
										<span class="mdl-textfield__error">Nombre Invalido</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="ApellidoClient" name="ApellidoClient">
										<label class="mdl-textfield__label" for="NameClient">APELLIDOS</label>
										<span class="mdl-textfield__error">Nombre Invalido</span>
									</div>
